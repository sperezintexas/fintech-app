...
- **Import from broker** — Setup → Import From Broker: upload CSV (Merrill, Fidelity, Schwab); activities append to an account and optionally update positions. See `docs/ghostbranch-feature.md`. Use a local `data/` folder for broker CSV files (gitignored, local-only).
