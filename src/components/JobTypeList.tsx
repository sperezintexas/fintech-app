  ...
  if (jobTypes.length === 0) {
    return (
      <div className="text-center py-12 bg-gray-50 rounded-xl">
        ...
        <h3 className="mt-3 text-base font-medium text-gray-900">No task types yet</h3>
        <p className="mt-1 text-sm text-gray-500">Create task types to use in scheduled tasks.</p>
      </div>
    );
  }
