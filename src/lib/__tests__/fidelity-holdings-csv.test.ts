 ...
 * Uses inline fixture; optional data/fidelity/Positions_All_Accounts.csv when present.
 */
...
const FIXTURE = path.join(REPO_ROOT, "data", "fidelity", "Positions_All_Accounts.csv");
